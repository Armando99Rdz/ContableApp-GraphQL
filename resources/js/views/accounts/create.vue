            ...
            <div class="flex flex-wrap">
                ...
                <div class="w-full md:w-1/2 px-3 mb-6">
                    ...
                    <div class="mt-1 relative rounded-md shadow-sm">
                        ...
                        <input v-model="form.balance" class="appearance-none block w-full bg-white text-gray-700 border rounded py-3 px-7 leading-tight focus:outline-none focus:bg-white focus:border-indigo-300" id="balance" type="number" placeholder="0.00">
                    </div>
                </div>
                <div class="w-full md:w-1/2 px-3 mb-6">
