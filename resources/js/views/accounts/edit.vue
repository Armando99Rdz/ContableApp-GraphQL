    ...
    <div class="w-full bg-white rounded-md overflow-hidden border-t border-b sm:border-l sm:border-r sm:rounded shadow">
        ...
        <div class="border-b">
            <div class="flex justify-start px-6 -mb-px">
                ...
                ></div>
                <h3 class="text-indigo-700 py-4 font-normal text-lg md:ml-1">Editar cuenta</h3>
            </div>
        </div>

        <div class="-mx-3 p-6 px-36">
            <div class="flex flex-wrap">
                ...
                <div class="w-full md:w-1/2 px-3 mb-6">
                    ...
                    <div class="mt-1 relative rounded-md shadow-sm">
                        ...
                        <input v-model="form.balance" class="appearance-none block w-full bg-white text-gray-700 border rounded py-2 px-7 leading-tight focus:outline-none focus:bg-white focus:border-indigo-300" id="balance" type="number" placeholder="0.00" disabled>
                    </div>
                </div>
                <div class="w-full md:w-1/2 px-3 mb-6">
                    ...
                    <input v-model="form.description" class="appearance-none block w-full bg-white text-gray-700 border rounded py-2 px-4 leading-tight focus:outline-none focus:bg-white focus:border-indigo-300" id="description" type="text" placeholder="">
                </div>
