                        ...
                        <div class="container mx-auto px-4">
                            <div class="md:flex">
                                <div class="flex -mb-px mr-8">
                                    <a href="/" class="no-underline text-indigo-700 md:text-indigo-700 flex items-center py-4 border-b border-indigo-700">
                                ...
                                <div class="flex -mb-px mr-8">
                                    <a href="/transactions" class="no-underline text-gray-500 opacity-50 md:opacity-100 flex items-center py-4 border-b border-transparent hover:opacity-100 md:hover:border-gray-800">
                                ...
                                <div class="flex -mb-px mr-8">
                                    <a href="/accounts" class="no-underline text-gray-500 opacity-50 md:opacity-100 flex items-center py-4 border-b border-transparent hover:opacity-100 md:hover:border-gray-800">
                                ...
                                <div class="flex -mb-px mr-8">
                                    <a href="/categories" class="no-underline text-gray-500 opacity-50 md:opacity-100 flex items-center py-4 border-b border-transparent hover:opacity-100 md:hover:border-gray-800">
                                ...
                                <div class="flex -mb-px">
                                    <a href="#" class="no-underline text-gray-500 opacity-50 md:opacity-100 flex items-center py-4 border-b border-transparent hover:opacity-100 md:hover:border-gray-800">
                                        <svg class="h-6 w-6 fill-current mr-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
